#' Provide names for 2005 Provider of Service file
#' 
#' @return A list of names for the POS 2005 dataset, in the order that the raw 
#'   data lists them
#'   
#'   This function returns the results of running \code{pos_names_extract} on
#'   the 2005 layout and raw data files.
#'   
#' @examples
#' 
#' # get the list
